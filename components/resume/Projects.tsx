...
export default function ProjectsSection() {
  return (
    <section className="mb-6">
      ...
      <div>
        <h3 className="font-semibold text-lg">Full Stack Developer — E-commerce Application</h3>
      ...
      <div className="mb-4">
        <h3 className="font-semibold text-lg">Full Stack Developer — Inventory</h3>
        <p className="text-sm text-gray-600">2023 – 2024</p>
        <ul className="list-disc ml-5 text-sm mt-1 space-y-1">
          <li>Developed a full-stack Inventory application using React.js, Nest.js, and PostgreSQL.</li>
          <li>Implemented core functionalities including product management, Sale, Purchase, Stock, Loss & Profit,etc.</li>
          <li>Integrated SSLCOMMERZ payment gateway for secure transactions.</li>
          <li>Project is 100% complete with responsive UI and optimized performance.</li>
        </ul>
      </div>
    </section>
  );
