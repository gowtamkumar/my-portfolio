export const site = {
  ...
  summary:
    "Full Stack Engineer with 5+ years shipping multi-tenant SaaS and e-commerce. Currently building Cayura at Astitva Lab Pty Ltd — NestJS, Next.js, PostgreSQL, Prisma, and Docker.",
  years: "5+",
  location: "Bangladesh",
